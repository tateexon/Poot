...
use noise::{core::worley::ReturnType, utils::*, Curve, *};
...
impl Heightmap {
    ...
    pub fn planet(seed: u32, x: f64, y: f64) -> Self {
        let mut buffer = [[0.0; SIZE as usize]; SIZE as usize];
        // ////////////////////////////////////////////////////////////////////////
        ...
        let lower_x_bounds = (x * SIZE) / scale;
        let upper_x_bounds = (x * SIZE + (SIZE - 1f64)) / scale;
        let lower_y_bounds = (y * SIZE) / scale;
        let upper_y_bounds = (y * SIZE + (SIZE - 1f64)) / scale;
